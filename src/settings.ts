...
export class VoiceNotesSettingTab extends PluginSettingTab {
  ...
  private async renderTemplateSettings(containerEl: HTMLElement): Promise<void> {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Template for synced notes. Available variables: {{recording_id}}, {{title}}, {{date}}, {{duration}}, {{created_at}}, {{updated_at}}, {{tags}}, {{tag_names}}, {{topics}}, {{transcript}}, {{embedded_audio_link}}, {{audio_filename}}, {{summary}}, {{tidy}}, {{points}}, {{todo}}, {{email}}, {{tweet}}, {{blog}}, {{custom}}, {{parent_note}} and {{related_notes}}'
      )
